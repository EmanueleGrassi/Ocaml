...
(* è una funzione che dato un grafo orientato e un nodo start restituisce *)
...
(* e se a è diverso da start, sollevando l'eccezione NotFound in tal caso. Altrimenti controlla se a è il nodo start*)
